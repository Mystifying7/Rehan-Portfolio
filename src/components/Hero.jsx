...
function Hero({ theme = "dark" }) {
  ...
  return (
    ...
    >
      ...
      {/* Radial Glow Overlay */}
      <div
        className={`pointer-events-none absolute inset-0 -z-10 ${isDark
      ...
      <div className="relative z-10 mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-12">
        ...
        >
          {/* Status Badge */}
          <div
            className={`mb-6 inline-flex items-center gap-2 rounded-full border px-4 py-2 text-xs font-bold shadow-xl backdrop-blur-xl ${isDark
          ...
          {/* Name & Title */}
          <p
            className={`mb-2 text-sm font-extrabold uppercase tracking-[0.25em] ${isDark ? "text-cyan-400" : "text-cyan-600"
              }`}
          >
            Md Rehan Alam
          </p>
          ...
          <h1
            className={`text-4xl font-black leading-tight sm:text-5xl md:text-6xl tracking-tight ${isDark ? "text-white" : "text-slate-900"
              }`}
          >
            Building{" "}
          ...
          <div className="mt-4 h-8 text-lg font-bold sm:text-xl">
            <motion.span
              ...
              className={`inline-flex items-center gap-2 ${isDark ? "text-cyan-300" : "text-cyan-700"
                }`}
            >
          ...
          {/* Bio */}
          <p
            className={`mt-5 max-w-xl text-sm leading-7 sm:text-base ${isDark ? "text-slate-300" : "text-slate-600"
              }`}
          >
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-2 lg:justify-start">
            {techStack.map((tech) => (
              <span
                key={tech}
                className={`rounded-full border px-3.5 py-1.5 text-xs font-semibold backdrop-blur-xl transition-all duration-300 ${isDark
